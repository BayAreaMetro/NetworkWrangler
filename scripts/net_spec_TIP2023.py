        ...
        (
            2015,
            {
                "hwy": [
                    ...
                    {
                        "name": "Bridge_Toll_Updates_2_2pct",
                        "kwargs": {"MODELYEAR": "2015"},
                    },
                ],
                "trn": [],
            },
        ...
        (
            2020,
            {
                "hwy": [
                    {
                        "name": "Bridge_Toll_Updates_2_2pct",
                        "kwargs": {"MODELYEAR": "2020"},
                    },
                    {
                        "name": "EXP_237B",
                        "kwargs": {"FUTURE": "PBA50"},
                    },  # todo: update this to support PBA50
                    "EXP_580C",
                    "EXP_680D",
                    "EXP_880A",
                    "HOV_680F",
        ...
        (
            2030,
            {
                "hwy": [
                    {
                        "name": "Bridge_Toll_Updates_2_2pct",
                        "kwargs": {"MODELYEAR": "2030"},
                    },
                    "EXP_Blueprint_NoProject",
                ],
                "trn": ["BART_NoProject", "SON090002_SMART_to_Windsor"],
            },
        ),
        (
            2035,
    ...
    [
        ...
        (
            2025,
            {
                "hwy": [
                    {
                        "name": "RRSP_Alameda_Point_Transit_Improvements",
                        "tag": "PBA50_Blueprint",
                    },
                    ...
                    {
                        "name": "MAJ_SOL070020_I80_I680_SR12_Int_2B_7",
                        "kwargs": {"PHASE": "'2B'"},
                    },
                    {
                        "name": "EXP_uncommitted_all",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_exclude": ["Alt1", "NextGenFwy"],
                    },
                    {
                        "name": "EIR1_EXP_uncommitted_all",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_include": ["Alt1"],
                    },
                    ...
                    {
                        "name": "EXP_uncommitted_noAllLaneTolling",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_include": ["NextGenFwy"],
                    },
                ],
                "trn": [
                    "FBP_AL_001_NewarkFremPDA",
                    {
                        "name": "FBP_MU_059_ACTransbay_Freq_Incr",
                        "variants_exclude": ["Alt2"],
                    },
                    "MAJ_AC_Frequency_Improvement",
                    {
                        "name": "RRSP_Alameda_Point_Transit_Improvements",
                    ...
                    {
                        "name": "EIR1_Freq_Boosts",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_include": ["Alt1"],
                    },
                    {
                        "name": "EIR2_HRA_Freq_Incr",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_include": ["Alt2"],
                    },
                    {
                        "name": "EIR2_PDA_Freq_Incr",
                        "kwargs": {"MODELYEAR": "2025"},
                        "variants_include": ["Alt2"],
                    },
                    {"name": "EIR2_Val_Link_ExpressBus", "variants_include": ["Alt2"]},
        ...
        (
            2030,
            {
                "hwy": [
                    ...
                    "BP_Vision_Zero",
                    {
                        "name": "FBP_AL_021_South_Bay_Connect",
                        "variants_exclude": ["Alt2"],
                    },
                    ...
                    {
                        "name": "FBP_CC_040_041_042_I680_SR4_Int_Phases_1_2_4_5",
                        "kwargs": {"PHASE": "'4'"},
                        "variants_exclude": ["Alt1"],
                    },
                    ...
                    {
                        "name": "FBP_SF_012_Geneva_Harney_BRT",
                        "kwargs": {"MODELYEAR": "2030"},
                    },
                    {
                        "name": "MAJ_Bay_Area_Forward_all",
                        "kwargs": {"MODELYEAR": "2030"},
                    },
                    {
                        "name": "BP_Tolls_On_Congested_Freeways_2030",
                        "variants_exclude": ["NextGenFwy"],
                    },
                    {
                        "name": "EXP_uncommitted_all",
                        "kwargs": {"MODELYEAR": "2030"},
                    ...
                    {
                        "name": "FBP_CC_050_SR4_Operation_Improvements_EB",
                        "variants_exclude": ["Alt1"],
                    },
                    {
                        "name": "FBP_CC_051_SR4_Operation_Improvements_WB",
                        "variants_exclude": ["Alt1"],
                    },
                    {
                        "name": "EXP_uncommitted_noAllLaneTolling",
                ...
                "trn": [
                    ...
                    {
                        "name": "MAJ_SF_050002_Caltrain_Ext_TransbayTerminal",
                        "variants_exclude": ["Alt2"],
                    },
                    ...
                    "MAJ_SCL050009_VTA_Eastridge_Extension",
                    {
                        "name": "FBP_SM_020_Regional_Express_Buses",
                        "kwargs": {"PHASE": "'Phase1_4Routes'"},
                    },
                    {
                        "name": "EIR1_Freq_Boosts",
                        "kwargs": {"MODELYEAR": "2030"},
                    ...
                    {
                        "name": "SON090002_SMART_NorthPetaluma",
                        "variants_exclude": ["Baseline"],
                    },
                ],
            },
        ),
        (
            2035,
            {
                "hwy": [
                    ...
                    {
                        "name": "BP_Tolls_On_Congested_Freeways_2035",
                        "variants_exclude": ["NextGenFwy"],
                    },
        ...
        (
            2040,
            {
                "hwy": [
                    ...
                    {
                        "name": "FBP_MR_021_101_580_Direct_Connector",
                        "variants_exclude": ["Alt1"],
                    },
                    {"name": "FBP_MU_056_Dumbarton_GRT", "variants_exclude": ["Alt2"]},
                    {
                        "name": "EIR2_Val_Link_ExpressBus",
                        "kwargs": {"action": "'revert'"},
                        "variants_include": ["Alt2"],
                    },
                    ...
                    {
                        "name": "Transform_AC_Transbay_Improvements",
                        "variants_include": ["Alt2"],
                    },
    ...
    if SCENARIO == "NoProject":
        ...
        for netmode in ["hwy", "trn"]:
            ...
            for project_idx in range(len(NETWORK_PROJECTS[YEAR][netmode]) - 1, -1, -1):
                ...
                if (
                    "variants_exclude" in project.keys()
                    and NET_VARIANT in project["variants_exclude"]
                ):
                    Wrangler.WranglerLogger.info(
                        "Removing {} {} {}".format(YEAR, netmode, project)
                    )
                ...
                if (
                    "variants_include" in project.keys()
                    and NET_VARIANT not in project["variants_include"]
                ):
                    Wrangler.WranglerLogger.info(
                        "Removing {} {} {}".format(YEAR, netmode, project)
                    )
...
for YEAR in NETWORK_PROJECTS.keys():
    ...
    if (len(NETWORK_PROJECTS[YEAR]["hwy"]) > 0) or (
        len(NETWORK_PROJECTS[YEAR]["trn"]) > 0
    ):
