            ...
            for req_netmode in REQUIREMENTS[netmode][project].keys():
                ...
                for req_proj in req_proj_list:
                    ...
                    Wrangler.WranglerLogger.debug(
                        "req_project_year=[{}]".format(req_project_year)
                    )
            ...
            for project in NETWORK_PROJECTS[model_year][netmode]:
                ...
                if cloned_SHA1 != head_SHA1:
                    ...
                    if continue_on_warning:
                        Wrangler.WranglerLogger.warninging(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--NGF_netvariant",
        choices=["BlueprintSegmented", "Mock", "Pathway1", "Pathway2"],
    ...
    elif (args.model_type == Wrangler.Network.MODEL_TYPE_TM1) & (
        args.project_name == "NGF"
    ):
    ...
    if args.project_name == "NGF":
        os.environ[
            "CHAMP_node_names"
        ] = "M:\\Application\\Model One\\Networks\\TM1_2015_Base_Network\\Node Description.xls"
        print()
    else:
    ...
    for YEAR in NETWORK_PROJECTS.keys():
        ...
        networks["hwy"].write(
            path=hwypath, name=HWY_NET_NAME, suppressQuery=True, suppressValidation=True
        )  # MTC TM1 doesn't have turn penalties
